...
ACTION_META = {
    ...
    "transfer_project_owner": ("bi-award",       "warning", "Chuyển quyền quản lý project"),
    "delete_project":      ("bi-trash3-fill",    "danger",  "Xoá project"),
    "archive_project":     ("bi-archive",        "secondary", "Lưu trữ / mở lại project"),
